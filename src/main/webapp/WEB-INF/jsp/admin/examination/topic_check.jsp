                        ...
                        <table class="table table-hover table-striped table-bordered ">
                            ...
                            <c:forEach items="${options}" var="op" varStatus="i">
                                <tr>
                                    ...
                                    <td>${op.applyType}</td>
                                    <td><a href="${pageContext.request.contextPath}/post/${op.post.id}">${op.topic.topicTitle}</a></td>
                                    <td>
                                        <a href="#">${op.brief}
                                    ...
                                    <td>
                                        <form action="${pageContext.request.contextPath}/admin/check" class="remakes" method="post">
                                            ...
                                            <input type="hidden" name="topicId" value="${op.topic.id}"/>
                                            <input type="hidden" name="applyUserId" value="${op.user.id}"/>
                                            <input type="hidden" name="topic.topicTitle" value="${op.topic.topicTitle}"/>

...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-md-1">
            <div class="input-group">
                <button class="btn btn-default" id="searchAll">显示全部 <span class="glyphicon glyphicon-menu-hamburger"></span></button>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(function () {
        ...
        $("#search").on("click", function () {
            let postTitleValue = $(":input[name='postTitle']").val();
            alert(postTitleValue)
            if (postTitleValue != null && postTitleValue !== '' && postTitleValue !== 'undefined') {
                return true;
            } else {
                alert("请正确填写帖子名")
                return false;

...
<div class="container-fluid">
    <div class="row main">
            ...
            <div id="panel-parent" class="panel-group">
                    ...
                    <div id="person-basic-info" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="list-unstyled">
                                <li><a href="basic_info/person_account.jsp" class="">账号信息</a>
                                </li>
                                <li class="active"><a href="basic_info/basic_info.jsp" class="">基本信息</a></li>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="panel">
                    ...
                    <div id="person_collections" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="list-unstyled">
                                <li><a href="collection/collection_posts.jsp" class="">贴子</a></li>
                                <li><a href="collection/collection_board.jsp" class="">板块</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="panel">
                    ...
                    <div id="person_themes_setting" class="panel-collapse collapse">
                        <div class="panel-body">
                            <ul class="list-unstyled">
                                <li><a href="themes/person_theme_setting.jsp" class="">基本样式</a></li>
        ...
        <div class="col-md-9">
            <!--是iframe的容器-->
            <!--<iframe src="post/person_posts.jsp" frameborder="0"
                    width="100%"
                    scrolling="no" id="placeholder"
    ...
    * *!/
    $(function () {
        $("ul.list-unstyled li").click(function () {
            $("#placeholder").attr("src", this.firstChild.href);
            return false;
        })
    })*/
</script>

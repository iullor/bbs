...
<div class="container-fluid">
    <div class="row main">
            ...
            <div id="panel-parent" class="panel-group">
                ...
                <div class="panel">
                    ...
                    <div id="person_apply" class="panel-collapse  collapse in">
                        <div class="panel-body">
                            <ul class="list-unstyled">
                                <li class="active"><a href="${pageContext.request.contextPath}/person/apply" class="">申请</a></li>
        ...
        <div id="list" class="col-md-8 container-inner">
            ...
            <form action="${pageContext.request.contextPath}/person/apply" method="post">
                <div class="one-line">
...
<script>
    ...
    $(function () {
        ...
        $("#options").on("change", function () {
            ...
            console.log(op)
            $.ajax({
                url: "${pageContext.request.contextPath}/person/apply/" + op,
                type: 'get',

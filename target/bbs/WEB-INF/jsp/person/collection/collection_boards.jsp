...
<div class="container-fluid">
    <div class="row main">
                    ...
                    <div id="person_collections" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <ul class="list-unstyled">
                                ...
                                <li class="active"><a href="/person/collection/boards" class="">板块</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-8 container-inner">
            <h3 class="text-danger"><i>关注的板块</i></h3>
            <hr>
            <div class="row">
                <div class="col-md-6">
                    <div class="panel panel-info">
                        <div class="panel-heading">
                            <h5 class="panel-title"><span><a
                                    href="../../foreground/area/area.jsp">计算机科学与技术</a></span>
                                <a href="#" class="pull-right text-danger"><span
